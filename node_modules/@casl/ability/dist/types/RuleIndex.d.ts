import { Rule, RuleOptions } from '@casl/ability/dist/types/Rule';
import { RawRuleFrom } from '@casl/ability/dist/types/RawRule';
import { Abilities, Normalize, SubjectType, AbilityParameters, AbilityTuple, ExtractSubjectType } from '@casl/ability/dist/types/types';
...
export declare class RuleIndex<A extends Abilities, Conditions> {
    ...
    get rules(): (import("@casl/ability/dist/types/types").ToAbilityTypes<A> extends infer T ? T extends import("@casl/ability/dist/types/types").ToAbilityTypes<A> ? T extends import("@casl/ability/dist/types/types").AbilityTupleType<string, SubjectType> ? import("@casl/ability/dist/types/RawRule").SubjectRawRule<T[0], T[1], Conditions> : import("@casl/ability/dist/types/RawRule").ClaimRawRule<Extract<import("@casl/ability/dist/types/types").ToAbilityTypes<A>, string>> : never : never)[];
