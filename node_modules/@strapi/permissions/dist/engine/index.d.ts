...
import type { PermissionEngineHooks, HookName } from '@strapi/permissions/src/engine/hooks';
import * as abilities from '@strapi/permissions/src/engine/abilities';
import { Permission } from '@strapi/permissions/src/domain/permission';
import type { PermissionRule } from '@strapi/permissions/src/types';
export { abilities };
