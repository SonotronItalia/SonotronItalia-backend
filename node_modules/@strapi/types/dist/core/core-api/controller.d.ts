...
import type { MatchFirst, Test } from '@strapi/types/src/utils';
import type { ControllerHandler } from '@strapi/types/src/core/controller';
/**
...
export type ContentType<T extends UID.ContentType> = MatchFirst<[
    Test<UID.IsCollectionType<T>, CollectionType>,
    Test<UID.IsSingleType<T>, SingleType>
], Base>;
