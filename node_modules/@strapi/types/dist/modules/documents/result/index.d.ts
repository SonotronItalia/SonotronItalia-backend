...
import type { Array, Constants, Guard, String, Cast, If, Extends, MatchFirst, Or, StrictEqual, IsNever } from '@strapi/types/src/utils';
import type { Params } from '@strapi/types/src/modules/documents';
type Pagination = {
    page: number;
    pageSize: number;
    pageCount: number;
