...
import type { Constants, Guard, If } from '@strapi/types/src/utils';
 ...
 */
type SingleAttribute<TSchemaUID extends UID.Schema> = 'id' | Guard.Never<string & Schema.NonPopulatableAttributeNames<TSchemaUID>, string>;
/**
 ...
 * type F = 'title'; // ❌
 */
export type ObjectNotation<TSchemaUID extends UID.Schema> = If<Constants.AreSchemaRegistriesExtended, {
    [TKey in ObjectNotationKeys<TSchemaUID>]?: TKey extends SingleAttribute<TSchemaUID> ? OrderKind.Any : TKey extends Schema.AttributeNamesWithTarget<TSchemaUID> ? ObjectNotation<Schema.Attribute.Target<Schema.AttributeByName<TSchemaUID, TKey>>> : never;
}, {
 ...
 */
type ObjectNotationKeys<TSchemaUID extends UID.Schema> = SingleAttribute<TSchemaUID> | Schema.AttributeNamesWithTarget<TSchemaUID>;
/**
