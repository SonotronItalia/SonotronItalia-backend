import type { Service, Controller, Policy, Middleware } from '@strapi/types/src/core';
import type { UID } from '@strapi/types/src/internal';
import type { ComponentSchema, ContentTypeSchema } from '@strapi/types/src/struct';
/**
