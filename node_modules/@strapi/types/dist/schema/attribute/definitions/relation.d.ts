import type { AttributeNamesByType, Attribute } from '@strapi/types/src/schema';
import type { ContentType } from '@strapi/types/src/data';
import type { Guard, String, Extends, If, Intersect } from '@strapi/types/src/utils';
...
export type RelationWithoutTarget<TRelationKind extends RelationKind.WithoutTarget = RelationKind.WithoutTarget> = {
