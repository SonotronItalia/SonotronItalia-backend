...
import { MongoQuery } from '@ucast/mongo/dist/types/types';
export declare const $and: CompoundInstruction<MongoQuery<any>[]>;
export declare const $or: CompoundInstruction<(import("@ucast/mongo/dist/types/types").MongoQueryOperators<any> | ({
    [x: string]: any;
} & import("@ucast/mongo/dist/types/types").MongoQueryTopLevelOperators<any>))[], {}>;
